...
/* Private defines -----------------------------------------------------------*/
#define ADC1_BASS_VOLUME_Pin GPIO_PIN_0
#define ADC1_BASS_VOLUME_GPIO_Port GPIOA
#define ADC1_ACCOMP_VOLUME_Pin GPIO_PIN_1
#define ADC1_ACCOMP_VOLUME_GPIO_Port GPIOA
#define ADC1_VIBRATO_Pin GPIO_PIN_2
#define ADC1_VIBRATO_GPIO_Port GPIOA
#define ADC1_SUSTAIN_Pin GPIO_PIN_3
#define ADC1_SUSTAIN_GPIO_Port GPIOA
