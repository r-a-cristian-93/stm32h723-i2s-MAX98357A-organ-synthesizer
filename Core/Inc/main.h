...
#define DIN_ORCHESTRA_FLUTE_8_Pin GPIO_PIN_13
#define DIN_ORCHESTRA_FLUTE_8_GPIO_Port GPIOB
#define DIN_ORCHESTRA_FLUTE_4_Pin GPIO_PIN_15
#define DIN_ORCHESTRA_FLUTE_4_GPIO_Port GPIOB
#define DIN_ORCHESTRA_VIOLIN_Pin GPIO_PIN_9
#define DIN_ORCHESTRA_VIOLIN_GPIO_Port GPIOD
#define DIN_ORCHESTRA_TRUMPET_Pin GPIO_PIN_11
#define DIN_ORCHESTRA_TRUMPET_GPIO_Port GPIOD
#define DIN_ORCHESTRA_CLARINET_Pin GPIO_PIN_13
#define DIN_ORCHESTRA_CLARINET_GPIO_Port GPIOD
#define DIN_VIBRATO_ON_OFF_Pin GPIO_PIN_15
#define DIN_VIBRATO_ON_OFF_GPIO_Port GPIOD
#define DIN_VIBRATO_DELAY_Pin GPIO_PIN_7
#define DIN_VIBRATO_DELAY_GPIO_Port GPIOC
#define DIN_EFFECT_PERCUTION_4_Pin GPIO_PIN_9
#define DIN_EFFECT_PERCUTION_4_GPIO_Port GPIOC
#define DIN_EFFECT_PIANO_Pin GPIO_PIN_9
#define DIN_EFFECT_PIANO_GPIO_Port GPIOA
#define DIN_EFFECT_HARPSICORD_Pin GPIO_PIN_10
#define DIN_EFFECT_HARPSICORD_GPIO_Port GPIOA
#define DIN_EFFECT_ECHO_BELLS_Pin GPIO_PIN_11
#define DIN_EFFECT_ECHO_BELLS_GPIO_Port GPIOC
#define DIN_EFFECT_SYNTH_WAH_Pin GPIO_PIN_0
#define DIN_EFFECT_SYNTH_WAH_GPIO_Port GPIOD
#define DIN_EFFECT_ORCHESTRA_CANCEL_Pin GPIO_PIN_2
